...
class EditTransactionContainer extends React.Component {
  onSubmit = transaction => {
    ...
    if (transaction.type === "Transfer") {
      ...
      this.props.startEditTransaction(this.props.transaction, transaction);
    }
...
const mapDispatchToProps = dispatch => ({
  ...
  startEditTransaction: (oldTransaction, transaction) =>
    dispatch(startEditTransaction(oldTransaction.id, transaction))
      .then(() => {
...
export default connect(mapStateToProps, mapDispatchToProps)(
  withStyles(styles)(EditTransactionContainer)
);
